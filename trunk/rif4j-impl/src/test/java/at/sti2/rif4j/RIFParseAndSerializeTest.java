...
public class RIFParseAndSerializeTest extends XMLTestCase {
	...
	@Test
	public void testParseAndSerializeXML_RIF_BLD() throws SAXException,
	...
	@Test
	public void testSerializePresentationSyntax_RIF_BLD() throws SAXException,
			IOException, ParserConfigurationException {
		String[] rifFiles = TestUtils.getRIFTestFiles("src/test/resources");
		assertNotNull(rifFiles);
	...
	private void testSerializePresentation_RIF_BLD(String fileName)
		...
		String serializedRIF = presentationSerializer.getString()
