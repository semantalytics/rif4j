...
public class XmlSerializerIT extends XMLTestCase {

	private static final Logger logger = LoggerFactory
			.getLogger(XmlSerializerIT.class);
	...
	public XmlSerializerIT(String fileName) {
	...
	public static Collection<Object[]> data() {
		...
		String[] rifFiles = TestUtils.getRIFTestFiles("src/test/resources/serialization");
		assertNotNull(rifFiles);

		for (int i = 0; i < rifFiles.length; i++) {
			String fileName = rifFiles[i];

			data.add(new Object[] { "serialization/" + fileName });
		}
